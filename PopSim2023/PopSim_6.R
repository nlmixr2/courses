...
s1 <- rxSolve(mod5, ev)
xyplot(center~time,data= s1, groups=id,type='l')
...
run005F
#          Parameter   Est.     SE %RSE Back-transformed(95%CI) BSV(CV%) Shrink(SD)%
#theta1       log ka -0.569  0.236 41.5  -0.569 (-1.03, -0.106)                     
#theta2       log cl  -2.01   0.05 2.49     -2.01 (-2.1, -1.91)                     
#theta3        log v   2.06 0.0787 3.82        2.06 (1.9, 2.21)                     
#EPS_prop   EPS_prop  0.117                               0.117                     
#EPS_pkadd EPS_pkadd  0.722                               0.722                     
#ETA_ka                                                             78.0      45.8% 
#ETA_cl                                                             28.7      3.70% 
