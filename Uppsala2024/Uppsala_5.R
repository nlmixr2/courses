...
#This implementation of fixed parameters is currently undergoing revision
#Themporary fix is to hard-code the parameters:

One.comp.transit.alloF <- function() {
  ini({
    # Where initial conditions/variables are specified
    lktr <- log(1.15)  #log k transit (/h)
...
save(run007FF, file = "run007F.Rdata")
